...
type NsqAdminServer struct {
	once     sync.Once
	nsqadmin *nsqadmin.NSQAdmin
}

func NewAdmin() *NsqAdminServer {
	return &NsqAdminServer{}
}

func (p *NsqAdminServer) Init(env svc.Environment) error {
...
func (p *NsqAdminServer) Start() error {
...
func (p *NsqAdminServer) Stop() error {
	p.once.Do(func() {
		p.nsqadmin.Exit()
	})
	return nil
