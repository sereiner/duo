...
type NsqLookUpServer struct {
	once       sync.Once
	nsqlookupd *nsqlookupd.NSQLookupd
}

func NewLookUp() *NsqLookUpServer {
	return &NsqLookUpServer{}
}

func (p *NsqLookUpServer) Init(env svc.Environment) error {
...
func (p *NsqLookUpServer) Start() error {
...
func (p *NsqLookUpServer) Stop() error {
	p.once.Do(func() {
		p.nsqlookupd.Exit()
	})
	return nil
